...
struct MD5Sum< ::franka_msgs::FrankaState_<ContainerAllocator> >
{
  ...
  {
    return "0aaac7d75db94290acd763669ea762b8";
  }

  static const char* value(const ::franka_msgs::FrankaState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0aaac7d75db94290ULL;
  static const uint64_t static_value2 = 0xacd763669ea762b8ULL;
};
