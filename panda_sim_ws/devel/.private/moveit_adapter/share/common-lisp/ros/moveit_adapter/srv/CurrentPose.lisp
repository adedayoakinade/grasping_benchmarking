...
(cl:defmethod cl:initialize-instance :after ((m <CurrentPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CurrentPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_adapter-srv:<CurrentPose-request> is deprecated: use moveit_adapter-srv:CurrentPose-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CurrentPose-request>)))
  ...
  "moveit_adapter/CurrentPoseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CurrentPose-request)))
  "Returns string type for a service object of type 'CurrentPose-request"
  "moveit_adapter/CurrentPoseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CurrentPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CurrentPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_adapter-srv:<CurrentPose-response> is deprecated: use moveit_adapter-srv:CurrentPose-response instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <CurrentPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_adapter-srv:pose-val is deprecated.  Use moveit_adapter-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CurrentPose-response>)))
  ...
  "moveit_adapter/CurrentPoseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CurrentPose-response)))
  "Returns string type for a service object of type 'CurrentPose-response"
  "moveit_adapter/CurrentPoseResponse")
