...
(cl:defmethod cl:initialize-instance :after ((m <GripperCommand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperCommand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_adapter-srv:<GripperCommand-request> is deprecated: use moveit_adapter-srv:GripperCommand-request instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <GripperCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_adapter-srv:width-val is deprecated.  Use moveit_adapter-srv:width instead.")
  (width m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GripperCommand-request>)))
  ...
  "moveit_adapter/GripperCommandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GripperCommand-request)))
  "Returns string type for a service object of type 'GripperCommand-request"
  "moveit_adapter/GripperCommandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GripperCommand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperCommand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_adapter-srv:<GripperCommand-response> is deprecated: use moveit_adapter-srv:GripperCommand-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GripperCommand-response>)))
  ...
  "moveit_adapter/GripperCommandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GripperCommand-response)))
  "Returns string type for a service object of type 'GripperCommand-response"
  "moveit_adapter/GripperCommandResponse")
