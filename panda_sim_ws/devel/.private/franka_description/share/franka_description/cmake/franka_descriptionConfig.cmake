...
if("TRUE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /root/grasping_benchmarking/panda_sim_ws/src/panda_simulation/franka_ros/franka_description)
  set(franka_description_DEVEL_PREFIX /root/grasping_benchmarking/panda_sim_ws/devel/.private/franka_description)
  ...
  set(franka_description_INSTALL_PREFIX /root/grasping_benchmarking/panda_sim_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/grasping_benchmarking/panda_sim_ws/src/panda_simulation/franka_ros/franka_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/grasping_benchmarking/panda_sim_ws/devel/.private/franka_description/lib;/root/grasping_benchmarking/panda_sim_ws/devel/lib;/opt/ros/noetic/lib)
