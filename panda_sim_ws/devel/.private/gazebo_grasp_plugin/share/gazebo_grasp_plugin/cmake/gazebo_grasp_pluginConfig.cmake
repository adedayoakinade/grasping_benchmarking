...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /root/grasping_benchmarking/panda_sim_ws/src/panda_simulation/grasp_plugin/gazebo-pkgs/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /root/grasping_benchmarking/panda_sim_ws/devel/.private/gazebo_grasp_plugin)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /root/grasping_benchmarking/panda_sim_ws/install)
...
if(NOT "/root/grasping_benchmarking/panda_sim_ws/src/panda_simulation/grasp_plugin/gazebo-pkgs/gazebo_grasp_plugin/include;/root/grasping_benchmarking/panda_sim_ws/build/gazebo_grasp_plugin/.. " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/root/grasping_benchmarking/panda_sim_ws/src/panda_simulation/grasp_plugin/gazebo-pkgs/gazebo_grasp_plugin/include;/root/grasping_benchmarking/panda_sim_ws/build/gazebo_grasp_plugin/..")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/grasping_benchmarking/panda_sim_ws/src/panda_simulation/grasp_plugin/gazebo-pkgs/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/grasping_benchmarking/panda_sim_ws/devel/.private/gazebo_grasp_plugin/lib;/root/grasping_benchmarking/panda_sim_ws/devel/lib;/opt/ros/noetic/lib)
