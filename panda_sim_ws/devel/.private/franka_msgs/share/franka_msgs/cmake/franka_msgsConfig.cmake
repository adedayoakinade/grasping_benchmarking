...
if("TRUE" STREQUAL "TRUE")
  set(franka_msgs_SOURCE_PREFIX /root/grasping_benchmarking/panda_sim_ws/src/panda_simulation/franka_ros/franka_msgs)
  set(franka_msgs_DEVEL_PREFIX /root/grasping_benchmarking/panda_sim_ws/devel/.private/franka_msgs)
  ...
  set(franka_msgs_INSTALL_PREFIX /root/grasping_benchmarking/panda_sim_ws/install)
...
if(NOT "/root/grasping_benchmarking/panda_sim_ws/devel/.private/franka_msgs/include " STREQUAL " ")
  set(franka_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/root/grasping_benchmarking/panda_sim_ws/devel/.private/franka_msgs/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/grasping_benchmarking/panda_sim_ws/src/panda_simulation/franka_ros/franka_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/grasping_benchmarking/panda_sim_ws/devel/.private/franka_msgs/lib;/root/grasping_benchmarking/panda_sim_ws/devel/lib;/opt/ros/noetic/lib)
