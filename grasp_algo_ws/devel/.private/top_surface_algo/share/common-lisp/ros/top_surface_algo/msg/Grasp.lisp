...
(cl:in-package top_surface_algo-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name top_surface_algo-msg:<Grasp> is deprecated: use top_surface_algo-msg:Grasp instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader top_surface_algo-msg:pose-val is deprecated.  Use top_surface_algo-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader top_surface_algo-msg:width-val is deprecated.  Use top_surface_algo-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'quality-val :lambda-list '(m))
(cl:defmethod quality-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader top_surface_algo-msg:quality-val is deprecated.  Use top_surface_algo-msg:quality instead.")
  (quality m))
