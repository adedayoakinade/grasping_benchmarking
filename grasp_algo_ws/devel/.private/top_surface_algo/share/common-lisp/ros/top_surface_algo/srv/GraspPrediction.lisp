...
(cl:defmethod cl:initialize-instance :after ((m <GraspPrediction-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspPrediction-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name top_surface_algo-srv:<GraspPrediction-request> is deprecated: use top_surface_algo-srv:GraspPrediction-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GraspPrediction-request>)))
  ...
  "top_surface_algo/GraspPredictionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GraspPrediction-request)))
  "Returns string type for a service object of type 'GraspPrediction-request"
  "top_surface_algo/GraspPredictionRequest")
...
(cl:defclass <GraspPrediction-response> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (best_grasp
    :reader best_grasp
    :initarg :best_grasp
    :type top_surface_algo-msg:Grasp
    :initform (cl:make-instance 'top_surface_algo-msg:Grasp)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GraspPrediction-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspPrediction-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name top_surface_algo-srv:<GraspPrediction-response> is deprecated: use top_surface_algo-srv:GraspPrediction-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <GraspPrediction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader top_surface_algo-srv:success-val is deprecated.  Use top_surface_algo-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'best_grasp-val :lambda-list '(m))
(cl:defmethod best_grasp-val ((m <GraspPrediction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader top_surface_algo-srv:best_grasp-val is deprecated.  Use top_surface_algo-srv:best_grasp instead.")
  (best_grasp m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GraspPrediction-response>)))
  ...
  "top_surface_algo/GraspPredictionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GraspPrediction-response)))
  "Returns string type for a service object of type 'GraspPrediction-response"
  "top_surface_algo/GraspPredictionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GraspPrediction)))
  ...
  "top_surface_algo/GraspPrediction")