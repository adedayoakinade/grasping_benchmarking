...
// (in-package top_surface_algo.srv)
...
class EFDGraspRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EFDGraspRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EFDGraspRequest
    let len;
    let data = new EFDGraspRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EFDGraspRequest(null);
...
class EFDGraspResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EFDGraspResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EFDGraspResponse
    let len;
    let data = new EFDGraspResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'top_surface_algo/EFDGraspResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EFDGraspResponse(null);
...
module.exports = {
  Request: EFDGraspRequest,
  Response: EFDGraspResponse,
  md5sum() { return '31cd19eee6b183891282c4389a5aa49f'; },
  datatype() { return 'top_surface_algo/EFDGrasp'; }
};
