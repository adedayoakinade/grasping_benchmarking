...
"""autogenerated by genpy from top_surface_algo/GraspPredictionRequest.msg. Do not edit."""
import codecs
import sys
...
class GraspPredictionRequest(genpy.Message):
  ...
  _type = "top_surface_algo/GraspPredictionRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from top_surface_algo/GraspPredictionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
"""
  ...
  _slot_types = ['bool','top_surface_algo/Grasp']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.best_grasp is None:
        self.best_grasp = top_surface_algo.msg.Grasp()
    else:
      self.success = False
      self.best_grasp = top_surface_algo.msg.Grasp()
...
class GraspPrediction(object):
  _type          = 'top_surface_algo/GraspPrediction'
  _md5sum = '86d7d0d5a00535c6699247df54f62820'
