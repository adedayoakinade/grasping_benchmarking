...
(cl:defmethod cl:initialize-instance :after ((m <Grasp2DPrediction-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp2DPrediction-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_deep_grasp-srv:<Grasp2DPrediction-request> is deprecated: use ros_deep_grasp-srv:Grasp2DPrediction-request instead.")))

(cl:ensure-generic-function 'depth_image-val :lambda-list '(m))
(cl:defmethod depth_image-val ((m <Grasp2DPrediction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_deep_grasp-srv:depth_image-val is deprecated.  Use ros_deep_grasp-srv:depth_image instead.")
  (depth_image m))

(cl:ensure-generic-function 'rgb_image-val :lambda-list '(m))
(cl:defmethod rgb_image-val ((m <Grasp2DPrediction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_deep_grasp-srv:rgb_image-val is deprecated.  Use ros_deep_grasp-srv:rgb_image instead.")
  (rgb_image m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Grasp2DPrediction-request>)))
  ...
  "ros_deep_grasp/Grasp2DPredictionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grasp2DPrediction-request)))
  "Returns string type for a service object of type 'Grasp2DPrediction-request"
  "ros_deep_grasp/Grasp2DPredictionRequest")
...
(cl:defclass <Grasp2DPrediction-response> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (best_grasp
    :reader best_grasp
    :initarg :best_grasp
    :type ros_deep_grasp-msg:Grasp2D
    :initform (cl:make-instance 'ros_deep_grasp-msg:Grasp2D)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasp2DPrediction-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp2DPrediction-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_deep_grasp-srv:<Grasp2DPrediction-response> is deprecated: use ros_deep_grasp-srv:Grasp2DPrediction-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Grasp2DPrediction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_deep_grasp-srv:success-val is deprecated.  Use ros_deep_grasp-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'best_grasp-val :lambda-list '(m))
(cl:defmethod best_grasp-val ((m <Grasp2DPrediction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_deep_grasp-srv:best_grasp-val is deprecated.  Use ros_deep_grasp-srv:best_grasp instead.")
  (best_grasp m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Grasp2DPrediction-response>)))
  ...
  "ros_deep_grasp/Grasp2DPredictionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grasp2DPrediction-response)))
  "Returns string type for a service object of type 'Grasp2DPrediction-response"
  "ros_deep_grasp/Grasp2DPredictionResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Grasp2DPrediction-response>)))
  ...
  (cl:format cl:nil "bool success~%ros_deep_grasp/Grasp2D best_grasp~%~%~%================================================================================~%MSG: ros_deep_grasp/Grasp2D~%int32 px~%int32 py~%float32 angle~%float32 width~%float32 quality~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Grasp2DPrediction-response)))
  "Returns full string definition for message of type 'Grasp2DPrediction-response"
  (cl:format cl:nil "bool success~%ros_deep_grasp/Grasp2D best_grasp~%~%~%================================================================================~%MSG: ros_deep_grasp/Grasp2D~%int32 px~%int32 py~%float32 angle~%float32 width~%float32 quality~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grasp2DPrediction)))
  ...
  "ros_deep_grasp/Grasp2DPrediction")