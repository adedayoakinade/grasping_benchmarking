...
(cl:defmethod cl:initialize-instance :after ((m <Grasp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_deep_grasp-msg:<Grasp> is deprecated: use ros_deep_grasp-msg:Grasp instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_deep_grasp-msg:pose-val is deprecated.  Use ros_deep_grasp-msg:pose instead.")
  (pose m))
