...
(cl:defmethod cl:initialize-instance :after ((m <Grasp2DPrediction-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp2DPrediction-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gpd_ros-srv:<Grasp2DPrediction-request> is deprecated: use gpd_ros-srv:Grasp2DPrediction-request instead.")))

(cl:ensure-generic-function 'depth_image-val :lambda-list '(m))
(cl:defmethod depth_image-val ((m <Grasp2DPrediction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_ros-srv:depth_image-val is deprecated.  Use gpd_ros-srv:depth_image instead.")
  (depth_image m))

(cl:ensure-generic-function 'rgb_image-val :lambda-list '(m))
(cl:defmethod rgb_image-val ((m <Grasp2DPrediction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_ros-srv:rgb_image-val is deprecated.  Use gpd_ros-srv:rgb_image instead.")
  (rgb_image m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Grasp2DPrediction-request>)))
  ...
  "gpd_ros/Grasp2DPredictionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grasp2DPrediction-request)))
  "Returns string type for a service object of type 'Grasp2DPrediction-request"
  "gpd_ros/Grasp2DPredictionRequest")
...
(cl:defclass <Grasp2DPrediction-response> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (best_grasp
    :reader best_grasp
    :initarg :best_grasp
    :type gpd_ros-msg:Grasp2D
    :initform (cl:make-instance 'gpd_ros-msg:Grasp2D)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasp2DPrediction-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp2DPrediction-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gpd_ros-srv:<Grasp2DPrediction-response> is deprecated: use gpd_ros-srv:Grasp2DPrediction-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Grasp2DPrediction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_ros-srv:success-val is deprecated.  Use gpd_ros-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'best_grasp-val :lambda-list '(m))
(cl:defmethod best_grasp-val ((m <Grasp2DPrediction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_ros-srv:best_grasp-val is deprecated.  Use gpd_ros-srv:best_grasp instead.")
  (best_grasp m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Grasp2DPrediction-response>)))
  ...
  "gpd_ros/Grasp2DPredictionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grasp2DPrediction-response)))
  "Returns string type for a service object of type 'Grasp2DPrediction-response"
  "gpd_ros/Grasp2DPredictionResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Grasp2DPrediction-response>)))
  ...
  (cl:format cl:nil "bool success~%gpd_ros/Grasp2D best_grasp~%~%~%================================================================================~%MSG: gpd_ros/Grasp2D~%int32 px~%int32 py~%float32 angle~%float32 width~%float32 quality~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Grasp2DPrediction-response)))
  "Returns full string definition for message of type 'Grasp2DPrediction-response"
  (cl:format cl:nil "bool success~%gpd_ros/Grasp2D best_grasp~%~%~%================================================================================~%MSG: gpd_ros/Grasp2D~%int32 px~%int32 py~%float32 angle~%float32 width~%float32 quality~%~%"))
