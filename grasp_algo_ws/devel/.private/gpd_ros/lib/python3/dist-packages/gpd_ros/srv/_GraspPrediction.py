...
"""autogenerated by genpy from gpd_ros/GraspPredictionRequest.msg. Do not edit."""
import codecs
import sys
...
class GraspPredictionRequest(genpy.Message):
  ...
  _type = "gpd_ros/GraspPredictionRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from gpd_ros/GraspPredictionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GraspPredictionResponse(genpy.Message):
  ...
  _type = "gpd_ros/GraspPredictionResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','gpd_ros/Grasp']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.best_grasp is None:
        self.best_grasp = gpd_ros.msg.Grasp()
    else:
      self.success = False
      self.best_grasp = gpd_ros.msg.Grasp()
