...
(cl:defmethod cl:initialize-instance :after ((m <Grasp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name template_algo-msg:<Grasp> is deprecated: use template_algo-msg:Grasp instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader template_algo-msg:pose-val is deprecated.  Use template_algo-msg:pose instead.")
  (pose m))
