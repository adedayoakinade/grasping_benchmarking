...
(cl:in-package mask_based_algo-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasp2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mask_based_algo-msg:<Grasp2D> is deprecated: use mask_based_algo-msg:Grasp2D instead.")))

(cl:ensure-generic-function 'px-val :lambda-list '(m))
(cl:defmethod px-val ((m <Grasp2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-msg:px-val is deprecated.  Use mask_based_algo-msg:px instead.")
  (px m))

(cl:ensure-generic-function 'py-val :lambda-list '(m))
(cl:defmethod py-val ((m <Grasp2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-msg:py-val is deprecated.  Use mask_based_algo-msg:py instead.")
  (py m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Grasp2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-msg:angle-val is deprecated.  Use mask_based_algo-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Grasp2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-msg:width-val is deprecated.  Use mask_based_algo-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'quality-val :lambda-list '(m))
(cl:defmethod quality-val ((m <Grasp2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-msg:quality-val is deprecated.  Use mask_based_algo-msg:quality instead.")
  (quality m))
