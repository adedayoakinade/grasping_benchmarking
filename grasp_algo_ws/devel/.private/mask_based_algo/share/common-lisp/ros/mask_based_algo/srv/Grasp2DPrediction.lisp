...
(cl:in-package mask_based_algo-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasp2DPrediction-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp2DPrediction-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mask_based_algo-srv:<Grasp2DPrediction-request> is deprecated: use mask_based_algo-srv:Grasp2DPrediction-request instead.")))

(cl:ensure-generic-function 'depth_image-val :lambda-list '(m))
(cl:defmethod depth_image-val ((m <Grasp2DPrediction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-srv:depth_image-val is deprecated.  Use mask_based_algo-srv:depth_image instead.")
  (depth_image m))

(cl:ensure-generic-function 'rgb_image-val :lambda-list '(m))
(cl:defmethod rgb_image-val ((m <Grasp2DPrediction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-srv:rgb_image-val is deprecated.  Use mask_based_algo-srv:rgb_image instead.")
  (rgb_image m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Grasp2DPrediction-request>)))
  ...
  "mask_based_algo/Grasp2DPredictionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grasp2DPrediction-request)))
  "Returns string type for a service object of type 'Grasp2DPrediction-request"
  "mask_based_algo/Grasp2DPredictionRequest")
...
(cl:defclass <Grasp2DPrediction-response> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (best_grasp
    :reader best_grasp
    :initarg :best_grasp
    :type mask_based_algo-msg:Grasp2D
    :initform (cl:make-instance 'mask_based_algo-msg:Grasp2D)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasp2DPrediction-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp2DPrediction-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mask_based_algo-srv:<Grasp2DPrediction-response> is deprecated: use mask_based_algo-srv:Grasp2DPrediction-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Grasp2DPrediction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-srv:success-val is deprecated.  Use mask_based_algo-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'best_grasp-val :lambda-list '(m))
(cl:defmethod best_grasp-val ((m <Grasp2DPrediction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_based_algo-srv:best_grasp-val is deprecated.  Use mask_based_algo-srv:best_grasp instead.")
  (best_grasp m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Grasp2DPrediction-response>)))
  ...
  "mask_based_algo/Grasp2DPredictionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grasp2DPrediction-response)))
  "Returns string type for a service object of type 'Grasp2DPrediction-response"
  "mask_based_algo/Grasp2DPredictionResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Grasp2DPrediction-response>)))
  ...
  (cl:format cl:nil "bool success~%mask_based_algo/Grasp2D best_grasp~%~%~%================================================================================~%MSG: mask_based_algo/Grasp2D~%int32 px~%int32 py~%float32 angle~%float32 width~%float32 quality~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Grasp2DPrediction-response)))
  "Returns full string definition for message of type 'Grasp2DPrediction-response"
  (cl:format cl:nil "bool success~%mask_based_algo/Grasp2D best_grasp~%~%~%================================================================================~%MSG: mask_based_algo/Grasp2D~%int32 px~%int32 py~%float32 angle~%float32 width~%float32 quality~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grasp2DPrediction)))
  ...
  "mask_based_algo/Grasp2DPrediction")