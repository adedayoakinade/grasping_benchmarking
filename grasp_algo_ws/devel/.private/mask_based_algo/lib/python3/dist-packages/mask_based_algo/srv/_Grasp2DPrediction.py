...
"""autogenerated by genpy from mask_based_algo/Grasp2DPredictionRequest.msg. Do not edit."""
import codecs
import sys
...
class Grasp2DPredictionRequest(genpy.Message):
  ...
  _type = "mask_based_algo/Grasp2DPredictionRequest"
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from mask_based_algo/Grasp2DPredictionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
float32 quality"""
  ...
  _slot_types = ['bool','mask_based_algo/Grasp2D']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.best_grasp is None:
        self.best_grasp = mask_based_algo.msg.Grasp2D()
    else:
      self.success = False
      self.best_grasp = mask_based_algo.msg.Grasp2D()
...
class Grasp2DPrediction(object):
  _type          = 'mask_based_algo/Grasp2DPrediction'
